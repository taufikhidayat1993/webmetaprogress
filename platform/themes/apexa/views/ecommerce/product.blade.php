    ...
    <div class="card product-detail-tabs mt-5">
        <ul class="nav nav-pills nav-fill bb-product-content-tabs p-4 pb-0">
            ...
            @if (is_plugin_active('faq') && $product->faq_items)
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" aria-current="page" href="#tab_faqs">{{ __('FAQs') }}</a>
                </li>
            @endif
        </ul>
        ...
        <div class="bb-product-content-tabs-wrapper tab-content container p-4">
            ...
            @if (is_plugin_active('faq') && $product->faq_items)
                <div class="tab-pane fade" id="tab_faqs" role="tabpanel" aria-labelledby="nav-product-faqs-tab" tabindex="0">
                    <div class="tp-product-details-review-wrapper" id="product-faqs">
