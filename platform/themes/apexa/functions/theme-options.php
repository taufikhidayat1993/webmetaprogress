...
app()->booted(callback: function (): void {
    $headerStyles = [];
    ...
    theme_option()
        ...
        ->when(is_plugin_active('portfolio'), function (): void {
        ...
        ->setField([
            'id' => 'display_ecommerce_header_actions',
            'section_id' => 'opt-text-subsection-ecommerce',
            'type' => 'customSelect',
            'label' => __('Display ecommerce header actions?'),
            'attributes' => [
                'name' => 'display_ecommerce_header_actions',
                'list' => [
                    0 => __('No'),
                    1 => __('Yes'),
                ],
